...
ALTER TABLE
    "treatments"
ADD
    CONSTRAINT "treatments_id_foreign" FOREIGN KEY("id") REFERENCES "medical_histories"("id");

ALTER TABLE
    "medical_histories"
ADD
    CONSTRAINT "medical_histories_id_foreign" FOREIGN KEY("id") REFERENCES "treatments"("id");
